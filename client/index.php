    ...
    <body>
        ...
        <div id="mainContainer">
            ...
            <div id="guidance" class="guidance" style="display: none;">
                ...
                <p> If you have found this website but are not on the Discord server, 
                    please join The Language Sloth Discord server. 
                </p>

                <p> Please also be aware that this site will be completely inactive outside of 
                    Discord classes 
                </p>
            ...
            <div id="container" style="display: none;">
                ...
                When the quiz is active, this section will be replaced by the quiz content.
        ...
        function handleDirectControl(control) {
         ...
         document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelector('#accept').addEventListener('click', () => {
                ...
                document.cookie = "acceptTerms=" + Date.now() + "; domain=<?php echo COOKIE_DOMAIN?>; path=/; expires=Fri, 31 Dec 9999 23:59:59 GMT";
            ...
            document.querySelector('#setName').addEventListener('click', () => {
                ...
                document.cookie = "usersName=" + document.querySelector('#name').value + "; domain=<?php echo COOKIE_DOMAIN?>; path=/; expires=Fri, 31 Dec 9999 23:59:59 GMT";
